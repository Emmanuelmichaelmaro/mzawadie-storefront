...
export default class CartProvider extends React.Component<{ children: any }, CartInterface> {
    ...
    render() {
        ...
        return <CartContext.Provider value={this.state}>{children}</CartContext.Provider>;
    }
}
