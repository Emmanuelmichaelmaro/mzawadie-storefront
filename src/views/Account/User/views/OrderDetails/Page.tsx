...
import { DropdownMenu, IconButton } from "@mzawadie/prototype/atoms";
import { TaxedMoney } from "@mzawadie/prototype/containers";
import { OrderDetail_lines } from "@mzawadie/sdk/lib/fragments/gqlTypes/OrderDetail";
import { OrderByToken_orderByToken } from "@mzawadie/sdk/lib/queries/gqlTypes/OrderByToken";
import { UserOrderByToken_orderByToken } from "@mzawadie/sdk/lib/queries/gqlTypes/UserOrderByToken";
                ...
                {"invoices" in order && order?.invoices?.length > 0 && (
                    <div className="order-details__header-menu">
                        <DropdownMenu
                            type="clickable"
                            header={
                                <IconButton testingContext="expandButton" name="expand" size={28} />
                            }
                            items={[
                                {
