...
import { deleteEntriesForCache, getBuildManifest, getBuildManifestPages } from "./utils";
...
router.setRoute(/\/(graphql|dashboard|media|plugins|storybook|__)|\?(.+&)?no-cache=1$/, NetworkFirst);
