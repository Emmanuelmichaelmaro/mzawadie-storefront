...
const CheckoutShippingSubpageWithRef: RefForwardingComponent<SubpageCompleteHandler, SubpageBaseProps> = (
    ...
    const { checkout, availableShippingMethods, setShippingMethod } = useCheckout();

    const shippingMethods = availableShippingMethods || [];

    useImperativeHandle(ref, () => () => {
        checkoutShippingFormRef.current?.dispatchEvent(new Event("submit", { cancelable: true }));
    });
