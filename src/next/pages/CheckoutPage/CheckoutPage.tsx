...
const CheckoutPage: React.FC<NextPage> = () => {
    ...
    const handleSubmitPaymentSuccess = (order?: CompleteCheckout_checkoutComplete_order | null) => {
        setSubmitInProgress(false);
        setPaymentGatewayErrors([]);
    ...
    const paymentGateways = availablePaymentGateways && (
        <PaymentGatewaysList
            ...
            formId={CHECKOUT_GATEWAY_FORM_ID}
    ...
    useEffect(() => setSelectedPaymentGateway(payment?.gateway), [payment?.gateway]);
