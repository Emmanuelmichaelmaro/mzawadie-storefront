...
export const Secondary = styled(Primary)`
    box-shadow: inset 0px 0px 0px 3px ${(props) => props.theme.chip.colors.secondary.color};
...
export const CloseButton = styled.button<{
    ...
    &:hover {
        background-color: ${(props) => props.theme.chip.colors[props.color].hoverBackground};
        > svg > path {
