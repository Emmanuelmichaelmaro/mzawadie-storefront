...
storiesOf("@mzawadie/prototype/atoms/Message", module)
    .addParameters({ component: Message })
    .add("neutral snackbar", () => <Message title="Sample Message" onClick={onClick} />)
    ...
    .add("action snackbar", () => (
        <Message title="Sample Message" status="error" onClick={onClick} actionText="Try again" />
    ))
    .add("action card", () => (
        <Message title="Sample Message" status="success" onClick={onClick} actionText="Refresh">
            {lipsum}
        </Message>
    ));
