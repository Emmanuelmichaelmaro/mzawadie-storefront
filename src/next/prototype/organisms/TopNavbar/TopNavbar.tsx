...
import { ITopNavbarProps } from "./types";
...
export const TopNavbar: React.FC<ITopNavbarProps> = ({ items }: ITopNavbarProps) => {
    const [navVisible, setNavVisible] = React.useState(false);
    const [setRef, { width, node }] = useElementWidthChanged();
    const [currentElement, setCurrentElement] = React.useState<number | null>(null);
