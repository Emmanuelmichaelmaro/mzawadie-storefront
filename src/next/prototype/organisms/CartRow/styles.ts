...
export const Wrapper = styled.div<{ cartRowType: ICartRowType }>`
    ...
    width: 100%;
    ${(props) => (props.cartRowType === "condense" ? condenseWrapper : responsiveWrapper)}
    align-items: center;
...
export const Photo = styled.div<{ cartRowType: ICartRowType }>`
    ...
    ${(props) => (props.cartRowType === "condense" ? condensePhoto : responsivePhoto)}
...
export const Description = styled.div<{ cartRowType: ICartRowType }>`
    ...
    height: 100%;
    ${(props) => (props.cartRowType === "condense" ? condenseDescription : responsiveDescription)}
`;
...
export const Attributes = styled.div<{ cartRowType: ICartRowType }>`
    ...
    margin-left: -15px;
    ${(props) => (props.cartRowType === "condense" ? condenseAttributes : responsiveAttributes)}
`;
...
export const Price = styled.div<{ cartRowType: ICartRowType }>`
    ...
    ${(props) => (props.cartRowType === "condense" ? condensePrice : responsivePrice)}
...
export const PriceLabel = styled.p<{ cartRowType: ICartRowType }>`
    ${(props) => (props.cartRowType === "condense" ? condensePriceLabel : responsivePriceLabel)}
`;
...
export const Quantity = styled.div<{ cartRowType: ICartRowType }>`
    grid-area: quantity;
    min-width: 120px;
    ${(props) => (props.cartRowType === "condense" ? condenseQuantity : responsiveQuantity)}
`;
