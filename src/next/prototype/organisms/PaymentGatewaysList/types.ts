...
import { ICardData, IFormError, IPaymentGateway, IPaymentSubmitResult } from "@next/types";
import React from "react";

export interface IPaymentGatewaysListProps {
    /**
    ...
    /**
     * Method called when gateway error occurred.
     */
