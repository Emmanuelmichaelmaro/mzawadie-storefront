// @ts-nocheck
import { ICheckoutModelLine, ICheckoutModelLineVariant } from "@mzawadie/sdk/lib/helpers";
...
export const TOTAL_PRICE: ITaxedMoney = {
    gross: {
        amount: SUBTOTAL_PRICE.gross.amount + SHIPPING_PRICE.gross.amount - PROMO_PRICE.gross.amount,
        currency: "PLN",
    },
    net: {
        amount: SUBTOTAL_PRICE.net.amount + SHIPPING_PRICE.net.amount - PROMO_PRICE.net.amount,
        currency: "PLN",
    },
};
