...
import { ISideNavbarProps, ISideNavbarState } from "./types";
...
export const SideNavbar: React.FC<ISideNavbarProps> = ({ show, onHide, items, target }: ISideNavbarProps) => {
    ...
    const setView = React.useCallback((state: Partial<ISideNavbarState>) => {
        _setView((view) => ({
            ...view,
            ...state,
                ...
                >
                    {(state) => (
                        ...
                        >
                            ...
                            {items[view.index!].children[view.depth!].children.map((item, i) => (
