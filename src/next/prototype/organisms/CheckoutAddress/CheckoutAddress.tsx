...
import { ICheckoutAddressProps } from "./types";

/**
 * Address form used in checkout.
 */
const CheckoutAddress: React.FC<ICheckoutAddressProps> = ({
            ...
            <section>
                ...
                {shippingAddressRequired && (
                    <Checkbox
                        ...
                        onChange={() => setBillingAsShippingAddress(!billingAsShippingAddress)}
                    >
                    ...
                    <>
                        ...
                        {userAddresses ? (
                            <AddressGridSelector
                                ...
                                onSelect={(address, id) => setBillingAddress(address, undefined, id)}
                                newAddressFormId={newAddressFormId}
                            />
                        ) : (
                            <AddressForm
                                ...
                                handleSubmit={(address) => setBillingAddress(address, address?.email)}
