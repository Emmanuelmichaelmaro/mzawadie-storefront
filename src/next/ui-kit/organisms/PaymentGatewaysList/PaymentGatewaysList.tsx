...
import { DummyPaymentGateway, StripePaymentGateway } from "..";
import * as S from "./styles";
import { IPaymentGatewaysListProps } from "./types";

const PaymentGatewaysList: React.FC<IPaymentGatewaysListProps> = ({
    paymentGateways,
        ...
        <S.Wrapper>
            {paymentGateways.map(({ id, name, config }, index) => {
                ...
                switch (name) {
                    ...
                    //                     customLabel
                    //                 >
                    //                     <span data-test="checkoutPaymentGatewayAdyenName">{name}</span>
                    //                 </Radio>
                    //             </S.Tile>
                    //
                    //             {checked && (
