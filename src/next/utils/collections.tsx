...
import { prodListHeaderCommonMsg } from "../../core";
import { UnknownObject } from "./tsUtils";
...
export const SORT_OPTIONS: SortOptions = [
    ...
    {
        label: <FormattedMessage {...prodListHeaderCommonMsg.sortOptionsPriceDsc} />,
        value: "-price",
    },
    {
    ...
    {
        label: <FormattedMessage {...prodListHeaderCommonMsg.sortOptionsUpdatedAt} />,
        value: "updated_at",
    },
    {
        label: <FormattedMessage {...prodListHeaderCommonMsg.sortOptionsUpdatedAtDsc} />,
        value: "-updated_at",
    },
];

export const FilterQuerySet = {
    encode(valueObj: UnknownObject<string[]>) {
        const str: string[] = [];
