...
const { createSingleMessagesFile, default: manageTranslations } = require("react-intl-translations-manager");
...
manageTranslations({
    ...
    overrideCoreMethods: {
        outputSingleFile: (combinedFiles) => {
            const msgDescriptors = combinedFiles.reduce((acc, messages) => [...acc, ...messages.descriptors], []);
