export const CHECKOUT_SELECTORS = {
    ...
    SHIPPING_ADDRESS_SELECTORS: {
        ...
        sameAsShippingAddressCheckbox: "[data-test='checkoutAddressBillingAsShippingCheckbox']",
    ...
    REVIEW_SELECTORS: {
        shippingAddressTile: "[data-test=shippingAddressSection] > [data-test=addressTile]",
